...
int Output::GetCellStartX(const CellPosition& cellPos) const
{
	...
	int startX = UI.CellWidth * cellPos.HCell() + 1;
...
{
	///TODO: implement the following function as described in Output.h file
	int startY = UI.ToolBarHeight + UI.CellHeight * cellPos.VCell() + 1;
...
void Output::CreateDesignModeToolBar() const
{
	...
	MenuItemImages[ITM_ADD_LADDER] = "images\\icons8-ladder-96.jpg";
	MenuItemImages[ITM_ADD_SNAKE] = "images\\icons8-snake-64.jpg";
	MenuItemImages[ITM_ADD_CARD] = "images\\icons8-card-96.jpg";
	MenuItemImages[ITM_EXIT] = "images\\icons8-close-96.jpg";
	MenuItemImages[ITM_SWITCH_TO_PLAY_MODE] = "images\\icons8-arrow-96.jpg";

	MenuItemImages[ITM_COPY_CARD] = "images\\icons8-copy-96.jpg"; //IMAGE
	MenuItemImages[ITM_CUT_CARD] = "images\\icons8-cut1-96.jpg"; //IMAGE
	MenuItemImages[ITM_EDIT_CARD] = "images\\icons8-edit-property-96.jpg"; //IMAGE
	MenuItemImages[ITM_PASTE_CARD] = "images\\icons8-paste-96.jpg"; //IMAGE
	MenuItemImages[ITM_OPEN_GRID] = "images\\icons8-open-96.jpg"; //IMAGE
	MenuItemImages[ITM_SAVE_GRID] = "images\\icons8-save-96.jpg"; //IMAGE
	MenuItemImages[ITM_DELETE_GAME_OBJECT] = "images\\icons8-delete-96.jpg";  //IMAGE
...
void Output::CreatePlayModeToolBar() const
{
	...
	MenuItemImages[ITM_ROLL_DICE] = "images\\icons8-dice-96.jpg";
	MenuItemImages[ITM_INPUT_DICE_VALUE] = "images\\Menu_Input_Dice_Value.jpg"; //IMAGE
	MenuItemImages[ITM_NEW_GAME] = "images\\icons8-new-96.jpg"; //IMAGE
	MenuItemImages[ITM_EXIT_GAME] = "images\\icons8-close-96.jpg";
	MenuItemImages[ITM_SWITCH_TO_DESIGN_MODE] = "images\\icons8-double-left-96.jpg";
...
void Output::DrawLadder(const CellPosition& fromCell, const CellPosition& toCell) const
{
	...
	int NumHorizontalLines = fromCell.VCell() - toCell.VCell();
	int y = toStartY;
...
void Output::DrawSnake(const CellPosition& fromCell, const CellPosition& toCell) const
{
	...
	x[0] = x12 - xChange; x[1] = x12; x[2] = x12 + xChange; x[3] = x12;

	y[0] = y1; y[1] = y1 + yChange; y[2] = y1; y[3] = y1 - yChange;
